...
public class CategoryItemAdapter extends GroupAdapter<Category>{
	...
	protected View createView(int position, View convertView, ViewGroup parent) {
		...
		ImageLoader.getInstance().displayImage(imageView, ImageLoaderOptions.optionsByNullImg, category.getTvThumbnailLocalUrl(), category.getTvThumbnailUrl());
		
		if(category.getHasRelContent() > 0){
